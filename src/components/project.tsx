...
export default function Project({ project, index }: { project: Projects; index: number }) {
  ...
  return (
    <div className=" h-[calc(100%/1)] sm:h-[calc(100%/1)] md:h-[calc(100%/2)] lg:h-[calc(100%/3)] xl:h-[calc(100%/3)] flex flex-col  snap-start  h-max-[h-[calc(100%/3)] ] items-center justify-center lg:items-stretch lg:justify-between">
      <div className="project justify-center flex items-center  sm:px-14 py-2">
        <div className="sm:w-full p-1 flex items-center justify-center flex-wrap flex-row relative sm:justify-center lg:justify-start ">
          <div
            ...
            <br></br>
            <div className="link-container flex justify-between gap-3">
          ...
          <div
            ...
            className={`${
              activeProject.project === index && activeProject.active ? "animate-displaceUp lg:animate-displace" : "animate-displaceOutUp lg:animate-displaceOut"
            }
                     transition-all name  text-[80px] sm:text-[160px] md:text-[200px] lg:text-titles pt-2 cursor-pointer  hover:text-white 
                     text-center`}>
            <span className="mt-5 tracking-[-5px] animate-pulse">{project.name}</span>
          </div>
        </div>
      </div>
      <div>
